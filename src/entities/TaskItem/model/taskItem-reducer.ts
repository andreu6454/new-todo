...
import {
    ResultStatus, TaskPriorities,
    TaskStatuses,
    TaskType,
    todolistsAPI,
    UpdateTaskModelType
} from "../../TodolistItem/api/todolists-api";
...
import {addTodolistAC, removeTodolistAC, setTodolistsAC} from "../../TodolistItem/model/todolists-reducer";
