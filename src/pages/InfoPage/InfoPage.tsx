    ...
    return (
        <div className={styles.InfoPage}>
            ...
            <div className={styles.Container}>
                ...
                <p>- Создание и назначение приоритетов для задач;</p>
                <p>- Отметка задач как выполненных или невыполненных;</p>
                <p>- Фильтрация задач по статусу выполнения или приоритету;</p>
                <p>- Возможность добавления дополнительных деталей к задачам, таких как описание или дата выполнения;</p>
                <p>- Возможность создания нескольких списков дел для разных категорий или проектов.</p>
